...
void _bitgeneratorreaction_function_0(void* instance_args) {
    ...
    #line 41 "/Users/Amin/Desktop/RT/project/sender-receiver-LF/src/senderreceiver.lf"
    if (self->sent == 0) {
        lf_set(out, 1);
        self->sent = 1;
    }
#line 17 "c:\\Users\\Amin\\Desktop\\RT\\project\\sender-receiver-LF\\src-gen\\senderreceiver\\_bitgenerator.c"
}
