...
// file:/c:/Users/SabaEbrahimi/workspace/EmbeddedMaster/final_project/project2/src/senderreceiver.lf
#define LOG_LEVEL 2
...
const char* _lf_default_argv[] = { "dummy", "-o", "3", "sec" };
...
void _lf_initialize_trigger_objects() {
    ...
    }
    {
        ...
        // Initiaizing timer senderreceiver.sender.t.
        senderreceiver_sender_self[0]->_lf__t.offset = 0;
        senderreceiver_sender_self[0]->_lf__t.period = MSEC(100);
        // Associate timer with the environment of its parent
        envs[senderreceiver_main].timer_triggers[timer_triggers_count[senderreceiver_main]++] = &senderreceiver_sender_self[0]->_lf__t;
        senderreceiver_sender_self[0]->_lf__t.mode = NULL;
    ...
    }
    {
        int count = 0; SUPPRESS_UNUSED_WARNING(count);
        {
            ...
            envs[senderreceiver_main].is_present_fields[(0) * 1 + 0 + count] = &senderreceiver_bitgenerator_self[0]->_lf_out.is_present;
            #ifdef FEDERATED_DECENTRALIZED
            // Add output port senderreceiver.bitGenerator.out to array of intended_tag fields.
            envs[senderreceiver_main]._lf_intended_tag_fields[(0) * 1 + 0 + count] = &senderreceiver_bitgenerator_self[0]->_lf_out.intended_tag;
